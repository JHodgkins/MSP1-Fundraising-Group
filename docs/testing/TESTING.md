...
Please download the [logs-and-issues.xlsx](logs-and-issues.xlsx) from the GitHub repository or [view on Dropbox](https://www.dropbox.com/s/jg8cewama480tzr/logs-and-issues.xlsx?dl=0).  
